...
export function GoogleButton() {
  return (
    <Button
      type="button"
      variant="outline"
      className="w-full h-10 rounded-lg gap-2.5"
    ...
    >
      <svg width="15" height="15" viewBox="0 0 48 48">
        ...
        <path fill="#4CAF50" d="M24 44c5.3 0 10.1-2 13.7-5.4l-6.3-5.3C29.4 35 26.8 36 24 36c-5.3 0-9.6-3.4-11.2-8.1l-6.5 5C9.5 39.6 16.2 44 24 44z" />
        <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.2-4.2 5.6l6.3 5.3C39.9 37 44 31 44 24c0-1.3-.1-2.7-.4-3.5z" />
      </svg>
      Продолжить с Google
    </Button>
  )
